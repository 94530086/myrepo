...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.un1');e.setAttribute('src',(dpi>1)?((dpi>2)?'images/wei-ming-ming-87.png':'images/wei-ming-ming-58.png'):'images/wei-ming-ming-29.png');
var e=document.querySelector('.un3');e.setAttribute('src',(dpi>1)?((dpi>2)?'images/cydiaicon-234.png':'images/cydiaicon-156.png'):'images/cydiaicon-78.png');};
...
wl=new woolite();
wl.init();
wl.addAnimation($('.un2'), "0.50s", "0.00s", 1, 100);
wl.addAnimation($('.un4'), "0.50s", "0.00s", 1, 100);
wl.start();
